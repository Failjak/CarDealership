    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=10, verbose_name='balance')),
                ('car_prices', models.ManyToManyField(to='car.CarPrices', verbose_name='car_prices')),
                ('cars', models.ManyToManyField(related_name='cars', to='car.Car', verbose_name='cars')),
                ('cars_config', models.ManyToManyField(related_name='cars_config', to='car.CarConfiguration', verbose_name='cars_config')),
                ('users', models.ManyToManyField(to='user.User', verbose_name='users')),
            ],
            options={
                'abstract': False,
            },
